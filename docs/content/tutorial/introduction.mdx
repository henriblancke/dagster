...
A set of assets naturally forms a [DAG (directed acyclic graph)](https://en.wikipedia.org/wiki/Directed_acyclic_graph), where the edges correspond to data dependencies between assets. This DAG helps you to:
